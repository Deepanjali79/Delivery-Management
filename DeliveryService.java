...
public interface DeliveryService { // invoke service
	...
	public DeliveryEntity findById(long deliveryEntityTestId) throws RecordNotFoundException;

	public DeliveryEntity findById(DeliveryEntity bean) throws RecordNotFoundException;
