...
public class DeliveryEntityController {
	...
	@GetMapping(value = "/show2/{DeliveryId}", produces = "application/json")
	ResponseEntity<DeliveryEntity> findById(@RequestBody DeliveryEntity delivery) throws RecordNotFoundException {

		DeliveryEntity Id = deliveryService.findById(delivery);

		if (Id == null) {
			throw new RecordNotFoundException("DeliveryEntity with this Id" + delivery.getId() + " does not Exist");
